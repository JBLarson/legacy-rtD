...
class MyWindow:
	def __init__(self, win):
		...
		t1x, label1x, label1y, label4y = 475, 395, 50, 175
		...
		self.b2.place(x=butx, y=210)



		#visual buttons
		bx, by, bx2, by2 = 20, 50, 125, 175


		self.btn3=Button(win, text='Display\nPosition')
		self.b3=Button(win, text='Display\nPosition', width=12, height=3, bg='yellow', fg='blue', command=self.buysell)
		self.b3['font'] = myFont
		self.b3.place(x=bx2-100, y=by)

		self.btn4=Button(win, text='Display ROI')
		self.b4=Button(win, text='Display ROI', width=12, height=3, bg='yellow', fg='blue', command=self.roi)
		self.b4['font'] = myFont
		self.b4.place(x=bx2+80, y=by)

		self.btn5=Button(win, text='Display ROI - alt')
		self.b5=Button(win, text='Display ROI - alt', width=12, height=3, bg='yellow', fg='blue', command=self.altROI)
		self.b5['font'] = myFont
		self.b5.place(x=bx2-100, y=by2)

		self.btn6=Button(win, text='Overview')
		self.b6=Button(win, text='Overview', width=12, height=3, bg='yellow', fg='blue', command=self.overview)
		self.b6['font'] = myFont
		self.b6.place(x=bx2+80, y=by2)
		...
		self.b7.place(x=530, y=label4y-50)
...
window.title('Real-Time Derivative Model v1')
window.geometry("1000x300-1000-1000")
try:	
